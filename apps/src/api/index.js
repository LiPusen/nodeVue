...
export default {
	...
	//获取文章列表{带分页获取}
	getArticleList(data) {
		return instance.post(api.artlist, data);
	},
	// 不带分页获取文章
	getArticleLists(params) {
		return front_instance.post(api.fartlist, params);
	},
	// 根据classify获取文章列表
	getArticlesByClassify(params) {
		return front_instance.post(api.getList, params);
	},
	// 创建文章
	createArticle(params) {
		return instance.post(api.creatArc, params);
	},
	// 删除一篇文章
	removeOneArticle(params) {
		return instance.post(api.delArc, params);
	},
	// 根据postID获取一篇文章(带权限)
	getOneArticle(params) {
		return instance.post(api.getOne, params);
	},
	// 根据postID获取一篇文章(不带权限)
	getOneArticleNoAuth(params) {
		return front_instance.post(api.fgetOne, params);
	},
	// 编辑一篇文章
	editArticle(params) {
		return instance.post(api.editArc, params);
	},
	// 获取分类列表
	getClassify() {
		return instance.get(api.classArc);
	},
	getNoAuthClass() {
		return front_instance.get(api.fclassArc);
	},

	// 删除某一个分类
	removeClassifyList(params) {
		return instance.post(api.delClass, params);
	},
	// 添加分类
	addClassify(params) {
		return instance.post(api.addClass, params);
	},

	// 编辑分类
	editClassfy(params) {
		return instance.post(api.editClass, params);
	}
}